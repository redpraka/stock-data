  ...
  render() {
    return (
      <div className="layout-column align-items-center mt-50">
        ...
        {
          this.props.apiResponseStatus === false ? <div className="mt-50 slide-up-fade-in" id="no-result" data-testid="no-result">Good Afternoon, No Results Found for {this.state.date}, Please amend the date and try again.</div> : ""
        }         
      </div>
    );
  }
